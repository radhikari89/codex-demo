...
7. Discovery: evaluate Google OIDC integration after base auth lands.

## Acceptance Check

- Compared Spring Security-owned auth, Google/OIDC path, AWS Cognito, Auth0/Okta, and Firebase/Supabase.
